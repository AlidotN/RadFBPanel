        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    guildColor = table.Column<string>(nullable: true),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    maritalstatusID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FaMaritalstatusTitle = table.Column<string>(nullable: true),
                    EnMaritalstatusTitle = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    selectedOptions = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_genderID = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    packageOptionsID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_settingID = table.Column<long>(nullable: false),
                    fk_permiumPackageID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fk_userAccessID = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Tbl_userAccess_Fk_userAccessID",
                        column: x => x.Fk_userAccessID,
            ...
            migrationBuilder.CreateTable(
                name: "Tbl_questionnaireTemplate",
                columns: table => new
                {
                    questionnaireTemplateID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    questionnaireTemplateTitle = table.Column<string>(nullable: true),
                    questionnaireTemplateDescription = table.Column<string>(nullable: true),
                    fk_jobCategoryID = table.Column<long>(nullable: false),
                    questionnaireTemplateAddress = table.Column<string>(nullable: true),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tbl_questionnaireTemplate", x => x.questionnaireTemplateID);
                    table.ForeignKey(
                        name: "FK_Tbl_questionnaireTemplate_Tbl_jobCategory_fk_jobCategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumberConfirmed = table.Column<bool>(nullable: false),
                    fk_countryID = table.Column<int>(nullable: false),
                    fk_provinceID = table.Column<long>(nullable: false),
                    fk_jobCategoryID = table.Column<long>(nullable: false),
                    fk_userTypeID = table.Column<int>(nullable: false),
                    interdusedEmail = table.Column<string>(nullable: true),
                    ...
                    DeleteStatus = table.Column<bool>(nullable: false),
                    inactiveDate = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tbl_RadFBUsers_Tbl_province_fk_provinceID",
                        column: x => x.fk_provinceID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tbl_UnauthorizedWords_AspNetUsers_fk_ApplicationUser",
                        column: x => x.fk_ApplicationUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    activeSesionID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_userID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tbl_activities_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BlockedUsersID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_BlockingUSerID = table.Column<long>(nullable: false),
                    fk_BlockedUserID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisterDate = table.Column<string>(nullable: true),
                    fk_senderUserID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    followersID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_UserID = table.Column<long>(nullable: false),
                    fk_followerUSerID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_ReciverUserID = table.Column<long>(nullable: false),
                    fk_senderUserID = table.Column<long>(nullable: false),
                    MessageTime = table.Column<string>(nullable: true),
                    fk_messageTypeID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    messagesExceptionID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_userID = table.Column<long>(nullable: false),
                    fk_ExecptionUserID = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MuteUserID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_UserID = table.Column<long>(nullable: false),
                    fk_MutedUserID = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_pointID = table.Column<long>(nullable: false),
                    fk_userID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_PostTypeID = table.Column<long>(nullable: false),
                    fk_UserID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    posterCoust = table.Column<string>(nullable: true),
                    posterType = table.Column<string>(nullable: true),
                    fk_posterTemplateID = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tbl_poster_Tbl_RadFBUsers_fk_userID",
                        column: x => x.fk_userID,
                        principalTable: "Tbl_RadFBUsers",
                        principalColumn: "RadFbUserID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    questionFilterID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_subjectID = table.Column<long>(nullable: false),
                    fk_userID = table.Column<long>(nullable: false),
                    fk_JobCategoryID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_GenderID = table.Column<int>(nullable: false),
                    fk_mssID = table.Column<long>(nullable: false),
                    fk_CooperationID = table.Column<int>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false),
                    Fk_maritalstatus = table.Column<int>(nullable: false),
                    fk_UserID = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tbl_RealCient_Tbl_maritalStatus_Fk_maritalstatus",
                        column: x => x.Fk_maritalstatus,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    reportUsersID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_ReportingUSerID = table.Column<long>(nullable: false),
                    fk_ReportedUserID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    silentUserID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_userID = table.Column<long>(nullable: false),
                    fk_silentUSerID = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SuggestionUsersID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_UserID = table.Column<long>(nullable: false),
                    fk_SuggestedUSerID = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    userDiscountID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_discountID = table.Column<long>(nullable: false),
                    fk_userID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_majorID = table.Column<long>(nullable: false),
                    fk_gradeID = table.Column<long>(nullable: false),
                    fk_UserID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserJobStatusID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_JobStatusID = table.Column<long>(nullable: false),
                    fk_UserID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    usersQuestionsID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    usersQuestionsTitle = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tbl_usersQuestions_AspNetUsers_fk_admin",
                        column: x => x.fk_admin,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UsersSkillsID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_SkillID = table.Column<long>(nullable: false),
                    fk_UserID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    groupExceptionID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_userID = table.Column<long>(nullable: false),
                    fk_ExecptionGroupID = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    groupMessageDate = table.Column<string>(nullable: true),
                    groupMessageIsSeen = table.Column<bool>(nullable: false),
                    fk_groupID = table.Column<long>(nullable: false),
                    fk_senderUserID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    factorID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_payID = table.Column<long>(nullable: false),
                    price = table.Column<long>(nullable: false),
                    description = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "Tbl_UsersPackage",
                columns: table => new
                {
                    UserPackagesID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_packageID = table.Column<long>(nullable: false),
                    fk_payID = table.Column<long>(nullable: false),
                    fk_userID = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tbl_UsersPackage", x => x.UserPackagesID);
                    table.ForeignKey(
                        name: "FK_Tbl_UsersPackage_Tbl_permiumPackage_fk_packageID",
                        column: x => x.fk_packageID,
                        principalTable: "Tbl_permiumPackage",
                        principalColumn: "permiumPackageID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tbl_UsersPackage_Tbl_pay_fk_payID",
                        column: x => x.fk_payID,
                        principalTable: "Tbl_pay",
                        principalColumn: "payID",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Tbl_UsersPackage_Tbl_RadFBUsers_fk_userID",
                        column: x => x.fk_userID,
                        principalTable: "Tbl_RadFBUsers",
                        principalColumn: "RadFbUserID",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmploymentAdvApplyID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_ApplicantUserID = table.Column<long>(nullable: false),
                    fk_postID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tbl_EmploymentAdvApply_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmploymentAdvPostID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_CooperationTypeID = table.Column<int>(nullable: false),
                    fk_countryID = table.Column<int>(nullable: false),
                    fk_provinceID = table.Column<long>(nullable: false),
                    fk_jobCategoryID = table.Column<long>(nullable: false),
                    fk_PostID = table.Column<long>(nullable: false),
                    fk_genderID = table.Column<int>(nullable: false),
                    fk_grageID = table.Column<long>(nullable: false),
                    fk_mssID = table.Column<long>(nullable: false),
                    ...
                    EdvStatus = table.Column<bool>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tbl_EmploymentAdvPost_Tbl_province_fk_provinceID",
                        column: x => x.fk_provinceID,
                        principalTable: "Tbl_province",
                        principalColumn: "provinceID",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PostForwardID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_ForwardedUserID = table.Column<long>(nullable: false),
                    fk_ForwardingUserID = table.Column<long>(nullable: false),
                    fk_PostID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_postID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false),
                    Tbl_provinceprovinceID = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tbl_Question", x => x.QuestionID);
                    table.ForeignKey(
                        name: "FK_Tbl_Question_Tbl_province_Tbl_provinceprovinceID",
                        column: x => x.Tbl_provinceprovinceID,
                        principalTable: "Tbl_province",
                        principalColumn: "provinceID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Tbl_Question_Tbl_subject_fk_subjectID",
                        column: x => x.fk_subjectID,
                        principalTable: "Tbl_subject",
                        principalColumn: "subjectID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Tbl_questionnaire_Tbl_subject_fk_subjectID",
                        column: x => x.fk_subjectID,
                        principalTable: "Tbl_subject",
                        principalColumn: "subjectID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserRegistrationCoursesID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_RegisteredUserID = table.Column<long>(nullable: false),
                    fk_posterID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    storySeenID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_userID = table.Column<long>(nullable: false),
                    fk_storyID = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserWorkExperienceStampID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_UserWorkExperienceID = table.Column<long>(nullable: false),
                    fk_UserID = table.Column<long>(nullable: false),
                    fk_stampedUSerID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_UserID = table.Column<long>(nullable: false),
                    fk_QuestiontID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    savedQuestionID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_userID = table.Column<long>(nullable: false),
                    fk_QuestionID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DeclarationOfReadinessID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_volunteerUserID = table.Column<long>(nullable: false),
                    fk_questionnaireID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentLikeID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fk_AnswerToQuestionID = table.Column<long>(nullable: false),
                    fk_UserID = table.Column<long>(nullable: false),
                    DeleteStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Fk_userAccessID",
                table: "AspNetUsers",
                column: "Fk_userAccessID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_activities_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_EmploymentAdvApply_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_EmploymentAdvPost_fk_provinceID",
                table: "Tbl_EmploymentAdvPost",
                column: "fk_provinceID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_Question_Tbl_provinceprovinceID",
                table: "Tbl_Question",
                column: "Tbl_provinceprovinceID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_Question_fk_subjectID",
                table: "Tbl_Question",
                column: "fk_subjectID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_questionnaire_fk_subjectID",
                table: "Tbl_questionnaire",
                column: "fk_subjectID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_questionnaireTemplate_fk_jobCategoryID",
                table: "Tbl_questionnaireTemplate",
                column: "fk_jobCategoryID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_RadFBUsers_fk_provinceID",
                table: "Tbl_RadFBUsers",
                column: "fk_provinceID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_RealCient_Fk_maritalstatus",
                table: "Tbl_RealCient",
                column: "Fk_maritalstatus");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_UnauthorizedWords_fk_ApplicationUser",
                table: "Tbl_UnauthorizedWords",
                column: "fk_ApplicationUser");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tbl_UsersPackage_fk_packageID",
                table: "Tbl_UsersPackage",
                column: "fk_packageID");

            migrationBuilder.CreateIndex(
                name: "IX_Tbl_UsersPackage_fk_payID",
                table: "Tbl_UsersPackage",
                column: "fk_payID");

            migrationBuilder.CreateIndex(
                name: "IX_Tbl_UsersPackage_fk_userID",
                table: "Tbl_UsersPackage",
                column: "fk_userID");

            migrationBuilder.CreateIndex(
                name: "IX_Tbl_usersQuestions_fk_admin",
